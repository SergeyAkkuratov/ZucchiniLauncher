...
import { Button, CloseButton, Offcanvas, OverlayTrigger, Popover, Table } from "react-bootstrap";
        ...
        <>
            ...
            <Offcanvas show={show} onHide={handleCloseDetails} placement="bottom">
                <Offcanvas.Header closeButton>
                    <Offcanvas.Title>Test Details {props.type === "finished" && (<Button variant="success" onClick={openResults} className="float-right">Open Results</Button>)}</Offcanvas.Title>
                </Offcanvas.Header>
                <Offcanvas.Body>
